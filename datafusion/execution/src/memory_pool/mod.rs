...
impl MemoryReservation {
    ...
    pub fn shrink(&mut self, caller: &str, capacity: usize) {
        println!("MemoryReservation::shrink, {}, {:?}", caller, capacity);
    ...
    pub fn grow(&mut self, caller: &str, capacity: usize) {
        println!("MemoryReservation::grow, {}, {:?}", caller, capacity);
    ...
    pub fn try_grow(&mut self, caller: &str, capacity: usize) -> Result<()> {
        ...
        println!("MemoryReservation::try_grow, {}, {:?}", caller, capacity);
        self.size += capacity;
        Ok(())
    }
    ...
    pub fn split(&mut self, caller: &str, capacity: usize) -> MemoryReservation {
        println!("MemoryReservation::split, {}, {:?}", caller, capacity);
    ...
    pub fn new_empty(&self, caller: &str) -> Self {
        println!("MemoryReservation::new_empty, {}, {:?}", caller, 0);
        Self {
            size: 0,
            registration: self.registration.clone(),
        }
